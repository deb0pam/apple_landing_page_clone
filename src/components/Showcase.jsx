        ...
        <div className="wrapper">
          <div className="lg:max-w-md">
            ...
            <div className="space-y-5 mt-7 pe-10">
              ...
              <p>It drives Apple Intelligence on iPad Pro,so you can write,create,and accomplish more with ease.All in a design that's unbeliveably thin,light and powerful.</p>
