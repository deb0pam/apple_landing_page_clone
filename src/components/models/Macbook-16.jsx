...
Files: macbook-16.glb [639.28KB] > /home/x/apple_landing_page_clone/public/models/macbook-16-transformed.glb [629.72KB] (1%)
...
export default function MacbookModel16(props) {
  ...
  const texture=useTexture('/screen.png', (t) => { t.colorSpace = SRGBColorSpace; t.needsUpdate = true; })
  useEffect(()=>{
